                ...
                if (currentSettings.enableBook === true) {
                    if (canvas && giftImage && matrixCanvas) {
                        ...
                        if (giftImage.src && giftImage.src !== window.location.href && giftImage.src !== '' && !giftImage.src.includes('undefined')) {
                            ...
                            setTimeout(() => {
                                console.log('Hiding giftImage after 3 seconds');
                                giftImage.style.display = 'none';
                                // Delay showBook to after other animations
                                setTimeout(() => {
                                    showBook();
                                }, 1000);
                            }, 3000);
...
function showBook() {
    ...
    if (book && bookContainer) {
        ...
        // Charger les pages dynamiquement via JavaScript
        loadBookPages();

        // Assigner les images aux pages après génération
        assignImagesToBookPages();
...
function loadBookPages() {
    const book = document.getElementById('book');
    const totalImages = 6; // nombre d’images dans /uploads/images
    book.innerHTML = '';
    ...
    for (let i = 1; i <= totalImages; i++) {
        ...
        page.innerHTML = `<img src="uploads/page${i}.jpg" alt="Page ${i}">`;
...
const uploadImages = [
    'uploads/birthday-20250708-072056-bolsw2.jpg',
    'uploads/birthday-20250708-072059-lhvuck.jpg',
    'uploads/birthday-20250708-072102-fjr3qh.jpg',
    'uploads/birthday-20250708-072106-8u5tf7.jpg',
    'uploads/birthday-20250708-072109-tbutvj.jpg'
];

function assignImagesToBookPages() {
    const book = document.getElementById('book');
    if (!book) return;
    ...
    pages.forEach((page, index) => {
        ...
        if (uploadImages[index]) {
            ...
            img.setAttribute('data-page-index', index);
            img.setAttribute('data-image-url', uploadImages[index]);
            img.style.width = '100%';
...
// Call this function after book pages are rendered or updated
